...
int main(void){
        ...
        uint16_t OutLow = 0;
        uint16_t temp = 0;
        uint16_t MaxCount = 16;
        uint16_t CurrentCount = MaxCount;
        uint16_t ONE = 1;
        uint16_t truthMask = 0;
        uint16_t tempShiftLOW = 0;
        uint16_t tempShiftHIGH = 0;
        ///////////UNUSED IN ASSEMBLER/////////
        uint16_t Input1;
        uint16_t Input2;
        uint16_t tempInput1;
...
START:  CurrentCount = 16;
        printf("Result = %x, Outhigh = %x Outlow = %x ",Input1*Input2,OutHigh,OutLow);
        OutHigh = 0;
        OutLow = 0;
